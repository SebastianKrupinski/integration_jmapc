 ...
 *
 */
class MailMessageAttachmentObject implements \OCP\Mail\Provider\IAttachment {
	protected MailMessagePartObject $_meta;
	protected ?string $_contents = null;

	public function __construct(?MailMessagePartObject $meta = null, ?string $contents = null) {
		// determine if meta data exists
		// if meta data is missing create new
		if ($meta === null) {
			$meta = new MailMessagePartObject();
	 ...
	 */
	public function setParameters(?MailMessagePartObject $meta): self {
	 ...
	 */
	public function getParameters(): MailMessagePartObject {
