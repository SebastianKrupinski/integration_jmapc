...
use OCA\JMAPC\Utile\Eas\EasXmlEncoder;
use OCA\JMAPC\Utile\Eas\EasXmlDecoder;
use OCA\JMAPC\Utile\Eas\EasObject;
use OCA\JMAPC\Utile\Eas\EasCollection;
use OCA\JMAPC\Utile\Eas\EasProperty;
use OCA\JMAPC\Utile\Eas\EasException;
...
class RemoteCommonService {
	...
	public function createEntity(EasClient $DataStore, string $cid, string $cst, string $type, EasObject $data): EasObject | null {
		...
		$o->Sync->Collections->Collection->Commands->Add->ClientId = new EasProperty('AirSync', \OCA\JMAPC\Utile\UUID::v4());
