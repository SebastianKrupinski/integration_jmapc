...
use OCA\JMAPC\Service\Remote\RemoteCoreService;

class RemoteCoreServiceFM extends RemoteCoreService {
	...
	public function initialize(Client $dataStore, ?string $dataAccount = null) {
		...
		if ($dataAccount === null) {
			if ($this->resourceNamespace !== null) {
				...
				$this->dataAccount = $dataStore->sessionAccountDefault('https://www.fastmail.com/dev/user', false);
			}
		} else {
